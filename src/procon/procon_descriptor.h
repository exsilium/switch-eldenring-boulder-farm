...
// Standard Pro Controller HID report descriptor (203 bytes / 0xCB).
// Ported verbatim from the documented descriptor used by retro-pico-switch /
// dekuNukem's reverse engineering notes. Report IDs:
//   0x30 (input, full state)  0x21 (input, subcommand reply)  0x81 (input, USB)
//   0x01/0x10 (output)        0x80/0x82 (output, USB)
static const uint8_t kReportDescriptor[] = {
    ...
    0x65, 0x14,                    //   Unit (Eng Rotation, Length: cm)
